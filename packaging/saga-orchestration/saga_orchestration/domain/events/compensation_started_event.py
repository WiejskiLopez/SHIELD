...
class CompensationStartedEvent(DomainEvent):
    """Wejście w COMPENSATING — emitowane RAZ, z pierwszą kompensatą ze stosu."""
    ...
    @classmethod
    def now(
        cls, *, saga_id: SagaId, compensation: StepName, at: datetime

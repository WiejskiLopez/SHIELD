"""Składanie UoW sagi w scheduling_service. Jedyny plik infra sagi (obok result writer)."""
...
class SchedulingCommandOutboxWriter(CommandOutboxWriter):
    """Wiersz libki -> command_outbox schedulingu na ZWIĄZANEJ sesji (bez commit)."""
...
def build_scheduling_saga_unit_of_work_factory(
    *,
    ...
    return build_sql_saga_unit_of_work_factory(
        ...
        writer_factory=SchedulingCommandOutboxWriter,
    )

...
def create_graph_definition_app(container: ContainerProtocol, *, api_key: str = "") -> FastAPI:
    ...
    """
    if not api_key:
        raise ValueError("create_graph_definition_app requires a non-empty api_key (fail-closed)")
